...
"""
Tests bzip2 runs at each processor step; runs
...
def trace_runs(file, freq):
    ...
    bzip2, assigns process to core 0, and calls
	...
	#cpufreq-set reads frequencies oddly
        ...
        for i in range(run_range):
            ...
            # == 'bzip2 -c test_bzip2_1.txt > ./download_files/test_bzip2_1.txt.bz2'
            proc = Popen('bzip2 -c test_bzip2_1.txt > ' +
                         './download_files/test_bzip2_1.txt.bz2', shell = True)
            pid = str(proc.pid)
