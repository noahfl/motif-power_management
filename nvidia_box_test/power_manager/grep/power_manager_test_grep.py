...
"""
Tests grep runs at each processor step; runs
...
def trace_runs(file, freq):
    ...
    grep, assigns process to core 0, and calls
	...
	#cpufreq-set reads frequencies oddly
        ...
        for i in range(run_range):
            ...
            # == 'grep "33154" ./strace_samples/*.txt'
            proc = Popen('grep "33154" ./strace_samples/*.txt', shell = True)
            pid = str(proc.pid)
